#!/usr/bin/env python
"""
Simple tool to display term rankings generated by NMF/LDA, stored in one or more PKL
files.

Sample usage:
python display-top-terms.py base-nmf/ranks_1000_001.pkl 
"""
...
def main():
	...
	for in_path in args:
		...
		log.info( "Model has %d rankings covering %d terms" % ( len(term_rankings), m ) )
